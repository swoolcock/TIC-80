...
if(BUILD_WITH_ANGELSCRIPT)
    ...
    set(ANGELSCRIPT_DIR ${THIRDPARTY_DIR}/angelscript/sdk/angelscript)
    set(ANGELSCRIPT_SRC
    ...
    list(APPEND ANGELSCRIPT_SRC ${CMAKE_SOURCE_DIR}/src/api/angelscript.c)
    ...
    target_include_directories(angelscript PUBLIC ${ANGELSCRIPT_DIR}/include)
    target_include_directories(angelscript PRIVATE ${ANGELSCRIPT_DIR}/source)
